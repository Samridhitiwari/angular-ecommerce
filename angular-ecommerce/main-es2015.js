...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p *ngFor=\"let tempProduct of products\">\n    {{ tempProduct.name}}: {{ tempProduct.unitPrice | currency:'USD'}}\n</p>");
...
let ProductService = class ProductService {
    ...
    getProductList() {
        return this.httpClient.get(this.baseUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(response => response._embedded.products));
    }
};
...
module.exports = __webpack_require__(/*! C:\Users\Rainwater\Desktop\ecommerce-project\03-frontend\angular-ecommerce\src\main.ts */"./src/main.ts");
